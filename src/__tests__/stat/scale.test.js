...
describe('scale matrix', () => {
  ...
  it('should scale by row', () => {
    ...
    expect(Array.from(scaled.data[0])).toStrictEqual([
      0.26967994498529685, 0.5393598899705937, 0.8090398349558905,
      1.0787197799411874, 1.348399724926484,
    ]);
  });
  ...
  it('should scale by column', () => {
    ...
    expect(Array.from(scaled.data[0])).toStrictEqual([
      0.26967994498529685, 0.26967994498529685, 0.26967994498529685,
      0.26967994498529685, 0.26967994498529685,
    ]);
  });
